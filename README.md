...
### Syllabus Tracker PDF
The syllabus tracker now uses a compact A4 portrait layout matching the supplied reference: #, Chapter Name, Lecture Tracker, Total Lec, Lec Comp, Mains Level, Adv Level, Short Notes, DPP and HW. Lecture/task ticks are saved locally and carried into the PDF.
